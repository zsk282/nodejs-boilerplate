...
const auth = require('../../src/modules/core/middlewares/auth');
const { tokenService, emailService } = require('../../src/modules/core/services');
const ApiError = require('../../src/modules/core/utils/ApiError');
const setupTestDB = require('../utils/setupTestDB');
const { User, Token } = require('../../src/modules/core/models');
...
describe('Auth routes', () => {
  describe('POST /v1/auth/register', () => {
    ...
    test('should return 201 and successfully register user if request data is ok', async () => {
      ...
      expect(dbUser).toMatchObject({ name: newUser.name, email: newUser.email, role: 'staff', isEmailVerified: false });
